                    ...
                    : (productosPaginados.map((p: any) => {
                      ...
                      return (
                        <tr key={p.id} className="hover:bg-blue-50 transition-colors">
                          ...
                          <td className="p-5 text-right font-mono text-orange-500">{formatMoneyMX(iva)}</td>
                          <td className="p-5 text-right font-mono font-bold text-green-600">{formatMoneyMX(total)}</td>
